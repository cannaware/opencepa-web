        ...
        <div className="bg-gray-100">
          <div className="max-w-screen-lg mx-auto px-3 py-6">
            <div className="jsx-4057204961 flex flex-wrap justify-between items-center">
              <div className="jsx-4057204961">
                <a className="jsx-4057204961" href="/demo/nextjs-landing-page/">
              ...
              <nav className="jsx-4057204961">
                <ul className="jsx-4057204961 navbar flex items-center font-medium text-xl text-gray-800">
                  <li>
                    <a href="https://github.com/cannaware/opencepa-web">GitHub</a>
                  </li>
                  <li>
                    <a href="/demo/nextjs-landing-page/">Sign in</a>
                  </li>
                </ul>
              </nav>
            </div>
          ...
          <div className="max-w-screen-lg mx-auto px-3 pt-20 pb-32">
            <header className="text-center">
              ...
              <a href="/">
                <div className="jsx-2452873545 btn btn-xl btn-primary">Comenzar</div>
              </a>
            </header>
          </div>
        </div>
        ...
        <div className="max-w-screen-lg mx-auto px-3 py-16">
          <div className="mb-12 text-center">
            ...
            <div className="mt-4 text-xl md:px-20">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus malesuada nisi
              tellus, non imperdiet nisi tempor at.
            </div>
          </div>
          <div className="mt-20 flex flex-wrap items-center">
            <div className="w-full sm:w-1/2 text-center sm:px-6">
              <h3 className="text-3xl text-gray-900 font-semibold">Your title here</h3>
              <div className="mt-6 text-xl leading-9">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse bibendum, nunc
                non posuere consectetur, justo erat semper enim, non hendrerit dui odio id enim.
              </div>
            </div>
        ...
        <div className="max-w-screen-lg mx-auto px-3 py-16">
          <div className="text-center flex flex-col p-4 sm:text-left sm:flex-row sm:items-center sm:justify-between sm:p-12 bg-primary-100 rounded-md">
            <div className="text-2xl font-semibold">
              ...
              <div className="text-primary-500">Start your Free Trial.</div>
            </div>
            <div className="whitespace-no-wrap mt-3 sm:mt-0 sm:ml-2">
              <a href="/">
                <div className="jsx-2452873545 btn btn-base btn-primary">Get Started</div>
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-100">
          <div className="max-w-screen-lg mx-auto px-3 py-16">
            <div className="jsx-541721229 text-center">
              ...
              <nav className="jsx-541721229">
                <ul className="jsx-541721229 navbar mt-5 flex flex-row justify-center font-medium text-xl text-gray-800">
                  <li>
                    <a href="/demo/nextjs-landing-page/">Home</a>
                  </li>
                  <li>
                    <a href="/demo/nextjs-landing-page/">About</a>
                  </li>
                  <li>
                    <a href="/demo/nextjs-landing-page/">Docs</a>
                  </li>
                  <li>
                    <a href="https://github.com/cannaware/opencepa-web">GitHub</a>
                  </li>
              ...
              <div className="jsx-541721229 mt-8 text-sm">
                <div className="jsx-3513251595 footer-copyright">
                  © Copyright 2021 OpenCepa. Con{' '}
                  <span role="img" aria-label="Love" className="jsx-3513251595">
                    ♥
                  </span>{' '}
                  <a href="https://cannaware.io" className="jsx-3513251595">
                    CANNAWARE
                  </a>
                </div>
              </div>
